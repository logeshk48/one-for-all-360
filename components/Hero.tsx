...
export default function Hero() {
  return (
    <section id="top" className="relative flex min-h-[96vh] flex-col justify-center overflow-hidden pt-28 pb-10">
      ...
      <div className="shell relative">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <div className="widen mx-auto mt-10 h-px w-32 bg-ink/15" aria-hidden="true" />

          <p className="rise mx-auto mt-9 max-w-xl text-base leading-relaxed text-ink/55 md:text-lg" style={{ animationDelay: "0.85s" }}>{hero.support}</p>

          <div className="rise mt-10 flex flex-col items-center gap-3 sm:flex-row sm:justify-center sm:gap-4" style={{ animationDelay: "1s" }}>
      ...
      <div className="shell relative mt-16 md:mt-20">
        <div className="rise hero-hairline h-px w-full" style={{ animationDelay: "1.15s" }} aria-hidden="true" />
        <ul className="rise grid grid-cols-2 gap-x-8 gap-y-7 pt-8 lg:grid-cols-4" style={{ animationDelay: "1.25s" }}>
